    ...
    body: JSON.stringify({
      ...
      messages: [
        ...
        },
        {
          role: "system",
          content:
            "涉及 42 时，优先围绕多 Agent 长任务协作、执行可靠性和证据约束的招聘 Agent，先讲问题与实际能力，再讲关键设计；普通后台功能、官网与文档数量作为补充，不作为主要卖点。只有追问架构时，才展开 Runtime、MCP、ACP 等细节。故障恢复是检查点与记录对账，不是自动断点续跑或不确定操作重放。不得虚构效率、准确率、业务规模或生产验证。桌面工作台为早期 Alpha，线上协作服务为已部署的 MVP，不得称为成熟生产产品或默认所有最新代码均已部署；新版官网不得声称已经上线公司主域名。",
        },
        ...context,
